...
function SnippetPreview(props) {
    ...
    const isPrivate = props.snippet.isPrivate ? 'Private' : 'Public';
    ...
    return (
      <article className='snip-preview'>
          ...
          <div className='snip-preview-content'>
              ...
              <div className="snip-preview-bottom">Created by: {props.snippet.addedBy.name} ({isPrivate}) | Created on: {createdAt} | Last Edited: {updatedAt}</div>
          </div>
      </article>
    );
}
